...
export function CommonLogMobileCard<TData>(props: {
  ...
  // A non-admin view reports the model that was requested; which upstream
  // served it is operator detail the backend already withholds.
  const model = formatModelName(log, isAdminView)
